 ...
 *
 */
public class SmsFromGtalks implements Comparable<SmsFromGtalks> {
     ...
     * @param date
     */
    public SmsFromGtalks(String phoneNumber, String message, Date date, String receiver) {
     ...
     */
    public SmsFromGtalks(String phoneNumber, String toName, String shortendMessage, int numParts, String answerTo, Integer id) {
        this.id = id;
    ...
    public SmsFromGtalks(int smsID, String phoneNumber, String name, String shortendMessage, String answerTo, String dIntents, String sIntents, int resSIntent, int resDIntent, long date) {
    ...
    @Override
    public int compareTo(SmsFromGtalks another) {
